...
**Chemin des identifiants :** Lansenger (client desktop) → Contacts → Rebots → Personal Rebots → cliquer sur l'icône ℹ️ pour voir les identifiants (le client mobile ne permet pas de voir les identifiants)
